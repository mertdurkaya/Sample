...
import com.mertdurkaya.Getir.logger.Log;
...
public class BaseTest {
    ...
    public void setUp(Scenario scenario) throws Exception {
        ...
        caps.setCapability(MobileCapabilityType.VERSION, "11.0.0");
        //caps.setCapability(MobileCapabilityType.UDID, "emulator-5554");
        caps.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.getir.casestudy.dev");
        caps.setCapability(AndroidMobileCapabilityType.APP_ACTIVITY, "com.getir.casestudy.modules.splash.ui.SplashActivity");
